...
With the current version, the expertise documents are available by clicking an expert's name, but they are not yet highlighted for areas that support a candate's selection. 
